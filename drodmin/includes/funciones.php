...
//acceso al sitio
function permitir($permitidos, $grupodeusuario) {
	$usuariospermitidos = Explode(",", $permitidos); 
	if(in_array($grupodeusuario, $usuariospermitidos)) {
		return true;
    } else {
		return false;
	}
...
function limitar($cadena, $longitud, $elipsis = "...") {  
